...
namespace Compsitor
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            razerPc.AddComponent(new Component("Razer PC Case", 59.99f));
            razerPc.AddComponent(new Component("Razer PC Leds", 29.99f));
            razerPc.AddComponent(new Component("Razer PC Fan", 19.99f));
            razerPc.AddComponent(new Component("Razer RGB Ram", 89.99f));
            ...
            utensilsPackage.AddComponent(new Component("10 Knives", 9.99f));
            utensilsPackage.AddComponent(new Component("10 Forks", 9.99f));
            utensilsPackage.AddComponent(new Component("10 Spoons", 9.99f));
