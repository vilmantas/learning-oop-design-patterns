...
namespace Decorator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            components.Add(new OutOfStockComponentDecorator(new Component("TV", 299.99f)));
            ...
            razerRig.AddComponent(new Component("Razer Gaming Keyboard", 19.99f, new AsteriskNameDisplayStrategy()));
            ...
            utensilsPackage.AddComponent(new OutOfStockComponentDecorator(new RestockingSoonComponentDecorator(new Component("10 Forks", 9.99f, new AsteriskNameDisplayStrategy()))));
